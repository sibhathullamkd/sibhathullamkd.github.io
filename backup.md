...
<head>
  ...
  <title> Sibhathulla mkd - personal portfolio</title>

  <!-- 
    - favicon
  -->
  <link rel="shortcut icon" href="assets/images/(fnnn1)sibhathulla_mkd.png" type="image/svg+xml">
...
<body id="top" class="dark_theme">
  ...
  <div class="hero-container">
    ...
    <div class="hero-left">
      <div class="hero-avatar">
        <img src="assets/images/(fnnn1)sibhathulla_mkd.png" alt="Profile Logo" class="hero-float" >
      </div>
    </div>

    <!-- RIGHT: CONTENT -->
    <div class="hero-right">
      <h1 class="hero-title">Muhammad Sibhathulla</h1>

      <p class="hero-subtitle">
        I design and build professional user interfaces.
      ...
      <section class="about" id="about">
        ...
        <figure class="about-banner">
          <img src="./assets/images/sibhathulla_mkd_ppf.jpeg" alt="sibhathulla mkd" style="border-radius: 15px;"
            class="w-100">
        </figure>
  ...
  <b>Hi, I’m <b style="color: rgb(166, 179, 176);">Sibhathulla</b></b> — a digital all-rounder who blends development, design, and technical skills. I work on modern websites, clean UI layouts, graphic design, video editing, and professional presentations (PowerPoint). I also explore penetration testing and security fundamentals, focusing on practical learning and smart problem-solving. I enjoy creating impactful, efficient, and visually strong digital experiences.
          <div class="btn-group">
            <button class="btn btn-secondary">Hire me</button>

            <button class="btn btn-primary">Explore My Projects</button>
          </div>
      ...
      <section class="skills" id="skills">
        ...
        <div class="skills-content section-content">
          ...
          <p class="section-text">
           ...
           I’m <b>Sibhathulla_mkd</b>, a digital all-rounder skilled in web development, UI design, graphic design, video editing, presentations, and security fundamentals.
          ...
          <ul class="skills-list">
            ...
            <li>
              <div class="skill-card">
                ...
                <div class="card-icon">
                  <img src="./assets/images/javascript.png" alt="cssflexbox" style="width: 50px; height: auto;">
                </div>
              </div>
            </li>
...
<li>
            ...
            <li>
              <div class="skill-card">
                ...
                <div class="card-icon">
                  <img src="./assets/images/photoshop.png" alt="Photoshop logo" style="width: 50px; height: auto;">
                </div>
              </div>
            </li>
             ...
             <li>
              <div class="skill-card">
                ...
                <div class="card-icon">
                  <img src="./assets/images/figma.png" alt="Photoshop logo" style="width: 50px; height: auto;">
                </div>
              </div>
            </li>
        ...
        <ul class="project-list">
          ...
          <li>
            <div class="project-content section-content">
              ...
              <p class="section-text">
                I craft long-term, high-quality websites using web, design, media, presentation, and security fundamentals, with a focus on clean and usable interfaces.
              </p>
...
-->
      ...
      <section class="contact" id="contact">
        ...
        <div class="contact-content section-content">
          ...
          <h2 class="h3 section-title">Have You Need Any Project? Please Drop a Message</h2>
          ...
          <ul class="contact-list">
            ...
            <li class="contact-list-item">
              ...
              <div class="wrapper">
                ...
                <a href="mailto:maizengg14@gmail.com" class="contact-info">maizengg14@gmail.com</a>
<br>

                 
                 
                               <div class="wrapper">
                                 <h3 class="h4 contact-item-title">Telegram:</h3>
                 
                                 <a href="https://t.me/sibhathullamkd" class="contact-info">@sibhathullamkd</a>
<br>

                
  <div class="wrapper">
                                 <h3 class="h4 contact-item-title">Instagram:</h3>
                 
                                 <a href="https://instagi/siram.com/sibhathulla_mkd" class="contact-info">@sibhathullamkd</a>
...
<br>
        ...
        <form action="https://formsubmit.co/maizengg14@gmail.com" method="POST" class="contact-form">
          ...
          <div class="form-wrapper">
            ...
            <div class="input-wrapper">
              ...
              <input type="tel" name="phone" id="phone"  placeholder="Phone Number" class="input-field">
  ...
  <footer class="footer">
    <div class="container">
      ...
      <p class="copyright">
        &copy; 2024 <a href="https://github.com/pkprajapati7402">Prince</a>. All rights reserved
      </p>
